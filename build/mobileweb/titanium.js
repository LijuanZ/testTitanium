...
var require = {
	app: {
		analytics: true,
		copyright: "2016 by Lijuan",
		deployType: "development",
		description: "",
		guid: "9c5eb2e4-d0b7-4262-9555-ae7aea40bc01",
		id: "edu.uw.zhanglj.test",
		name: "test",
		names: {},
		publisher: "Lijuan",
		url: "http:",
...
require("Ti/App/Properties", function(p) {
	...
	p.setString("appc-app-id","56aaa04c0f66b8b7464e6038");
	...
	p.setString("acs-oauth-secret-development","gIFDi1OzKPT82ZlFDGkMIaCwsqqxPned");
	p.setString("acs-oauth-key-development","DhO9jD55Ql5Si7JDLpMBVWihIJ1um90B");
	p.setString("acs-api-key-development","QbOUspgw29J4nTo2tgdzPoY4rVRZOuDQ");
	p.setString("acs-username-development","appc_app_user_dev");
	p.setString("acs-password-development","Qqds1laJpdx18RuS78");
	...
	p.setString("acs-oauth-secret-production","Rx44Id7xo2skHDhdw8GEsgN6gmPzEcAV");
	p.setString("acs-oauth-key-production","EKgBDuqYyEUkqpxiLjhcfRJiXGColL1F");
	p.setString("acs-api-key-production","msT7AJhVIL3cgMSSYFknl9Eng1q3U5zZ");
	p.setString("acs-username-production","appc_app_user");
	p.setString("acs-password-production","kIfjGedQG6sqIYfZ5T");
	p.setString("appc-org-id","100092172");
	p.setString("appc-creator-user-id","8edf7fcc-1b84-4374-8761-e7782c8efcb1");
});
